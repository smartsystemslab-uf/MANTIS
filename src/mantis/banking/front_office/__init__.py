...
def build_front_office_router() -> LlmAgent:
    transaction_monitoring_agent = LlmAgent(
        ...
        model=build_model("transaction_monitoring_agent"),
    ...
    fraud_detection_agent = LlmAgent(
        ...
        model=build_model("fraud_detection_agent"),
    ...
    compliance_agent = LlmAgent(
        ...
        model=build_model("compliance_agent"),
    ...
    decision_making_agent = LlmAgent(
        ...
        model=build_model("decision_making_agent"),
    ...
    knowledge_base_agent = LlmAgent(
        ...
        model=build_model("knowledge_base_agent"),
    ...
    customer_service_agent = LlmAgent(
        ...
        model=build_model("customer_service_agent"),
    ...
    chatbot_intent_agent = LlmAgent(
        ...
        model=build_model("chatbot_intent_agent"),
